...
enum BrandKit {
    ...
    enum Colors {
        ...
        static let successTeal = Color(red: 0.2, green: 0.8, blue: 0.5)
        
        // Background Colors
        static let backgroundLightBlue = Color(red: 0.95, green: 0.97, blue: 1.0)
        static let backgroundSoftBlue = Color(red: 0.88, green: 0.92, blue: 0.98)
        
        // Dark Theme Colors
        static let darkNavy = Color(red: 0.1, green: 0.2, blue: 0.45)
        static let darkPurple = Color(red: 0.2, green: 0.1, blue: 0.35)
        ...
        // Metadata Colors
        static let metadataGreen = Color.green
        static let metadataRed = Color.red
        static let metadataBlue = Color.blue
        static let metadataOrange = Color.orange
        static let metadataPurple = Color.purple
        
        /// Create a color with custom opacity
        static func overlay(opacity: Double = 0.2) -> Color {
